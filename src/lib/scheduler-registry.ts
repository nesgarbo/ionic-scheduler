...
/**
 * The definition registry: how `<ionic-scheduler-month-event *schedulerMonthEventDef>` reaches the
 * renderer that stamps it.
 *
 * Three pieces:
 *
 * 1. A **scope** (`<ionic-scheduler-content>`, `<ionic-scheduler-month>`, …) owns a slot → template map and
 ...
 *
 * `<ionic-scheduler-event *schedulerEventDef>` declared straight inside it is the fallback used by any
 * view with no narrower event definition.
 *
 * @group Components
 */
@Component({
    selector: 'ionic-scheduler-content',
    standalone: true,
    ...
    template: `
        ...
        @switch (state.view()) {
            @case ('day') {
                <ionic-scheduler-time-grid-view viewType="day" />
            }
            @case ('week') {
                <ionic-scheduler-time-grid-view viewType="week" />
            }
            @case ('resourceDay') {
                <ionic-scheduler-time-grid-view viewType="resourceDay" />
            }
            @case ('resourceWeek') {
                <ionic-scheduler-time-grid-view viewType="resourceWeek" />
            }
            @case ('dateDay') {
                <ionic-scheduler-time-grid-view viewType="dateDay" />
            }
            @case ('dateWeek') {
                <ionic-scheduler-time-grid-view viewType="dateWeek" />
            }
            @case ('resourceMonth') {
                <ionic-scheduler-month-view viewType="resourceMonth" />
            }
            @case ('dateMonth') {
                <ionic-scheduler-month-view viewType="dateMonth" />
            }
            @case ('month') {
                <ionic-scheduler-month-view viewType="month" />
            }
            @case ('agenda') {
                <ionic-scheduler-agenda-view />
            }
            @case ('year') {
                <ionic-scheduler-year-view />
            }
            @default {
                ...
                @if (timelineView(); as timeline) {
                    <ionic-scheduler-timeline-view [viewType]="timeline" />
                } @else {
                    <div class="ionic-scheduler-view-unavailable" role="status">{{ state.viewLabel(state.view()) }}</div>
                }
            }
        }
    `,
...
export abstract class SchedulerViewScope extends SchedulerScope {
    ...
    constructor() {
        super();
        if (!this.content) {
            throw new Error('[Scheduler] a view scope must be declared inside <ionic-scheduler-content>.');
        }
 ...
 */
@Component({
    selector: 'ionic-scheduler-month',
    standalone: true,
    template: `<ng-content />`,
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
 ...
 */
@Component({
    selector: 'ionic-scheduler-agenda',
    standalone: true,
    template: `<ng-content />`,
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
 ...
 */
@Component({
    selector: 'ionic-scheduler-timeline',
    standalone: true,
    template: `<ng-content />`,
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
 ...
 */
@Component({
    selector: 'ionic-scheduler-resource-day',
    standalone: true,
    template: `<ng-content />`,
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
 ...
 */
@Component({
    selector: 'ionic-scheduler-resource-week',
    standalone: true,
    template: `<ng-content />`,
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
 ...
 */
@Component({
    selector: 'ionic-scheduler-resource-month',
    standalone: true,
    template: `<ng-content />`,
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
 ...
 */
@Component({
    selector: 'ionic-scheduler-resource-timeline',
    standalone: true,
    template: `<ng-content />`,
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
 ...
 */
@Component({
    selector: 'ionic-scheduler-date-day',
    standalone: true,
    template: `<ng-content />`,
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
 ...
 */
@Component({
    selector: 'ionic-scheduler-date-week',
    standalone: true,
    template: `<ng-content />`,
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
 ...
 */
@Component({
    selector: 'ionic-scheduler-date-month',
    standalone: true,
    template: `<ng-content />`,
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
...
export abstract class SchedulerDef {
    ...
    ngOnInit(): void {
        if (!this.scope) {
            throw new Error(`[Scheduler] *scheduler${this.slot} must be declared inside <ionic-scheduler-content> or a view scope.`);
        }
...
@Directive({ selector: '[schedulerEventDef]', standalone: true })
...
@Directive({ selector: '[schedulerDayHeaderDef]', standalone: true })
...
@Directive({ selector: '[schedulerAllDayCellDef]', standalone: true })
...
@Directive({ selector: '[schedulerAllDayEventDef]', standalone: true })
...
@Directive({ selector: '[schedulerTimeGutterDef]', standalone: true })
...
@Directive({ selector: '[schedulerTimeGridCellDef]', standalone: true })
...
@Directive({ selector: '[schedulerWorkCellDef]', standalone: true })
...
@Directive({ selector: '[schedulerTimeGridEventDef]', standalone: true })
...
@Directive({ selector: '[schedulerMonthTitleDef]', standalone: true })
...
@Directive({ selector: '[schedulerMonthHeaderCellDef]', standalone: true })
...
@Directive({ selector: '[schedulerMonthCellDef]', standalone: true })
...
@Directive({ selector: '[schedulerMonthCellNumberDef]', standalone: true })
...
@Directive({ selector: '[schedulerMonthDayCellDef]', standalone: true })
...
@Directive({ selector: '[schedulerMonthEventDef]', standalone: true })
...
@Directive({ selector: '[schedulerMonthMoreLinkDef]', standalone: true })
...
@Directive({ selector: '[schedulerMiniMonthHeaderDef]', standalone: true })
...
@Directive({ selector: '[schedulerMiniMonthCellDef]', standalone: true })
...
@Directive({ selector: '[schedulerAgendaDateHeaderDef]', standalone: true })
...
@Directive({ selector: '[schedulerAgendaEventDef]', standalone: true })
...
@Directive({ selector: '[schedulerTimelineHeaderCellDef]', standalone: true })
...
@Directive({ selector: '[schedulerTimelineCellDef]', standalone: true })
...
@Directive({ selector: '[schedulerTimelineEventDef]', standalone: true })
...
@Directive({ selector: '[schedulerResourceColumnHeaderDef]', standalone: true })
...
@Directive({ selector: '[schedulerResourceAreaHeaderDef]', standalone: true })
...
@Directive({ selector: '[schedulerResourceHeaderDef]', standalone: true })
...
@Directive({ selector: '[schedulerResourceDef]', standalone: true })
...
@Directive({ selector: '[schedulerResourceGroupDef]', standalone: true })
...
@Directive({ selector: '[schedulerResourceRowDef]', standalone: true })
...
@Directive({ selector: '[schedulerResourceAggregateBadgeDef]', standalone: true })
