import type { SchedulerCategory, SchedulerEvent, SchedulerResource } from '../types/scheduler.types';
...
export function toICalendar(events: readonly SchedulerEvent[], options: SchedulerICalendarOptions = {}): string {
    const { prodId = '-//ionic-scheduler//scheduler//EN', name, titleField = 'title' } = options;
